...
This journal exists for one reason: to prove that my creative progression happened in real life and not just in my imagination at 2am.  
Week 1 was the classic p5.js “I can draw a circle therefore I am an artist” moment. I played with createCanvas() sizing, tried different background() values, and tested shapes like ellipse() and rect() while figuring out that coordinates are not 'vibes', they are numbers with logic behind them. I remember nudging positions manually like “okay, if I put this at x = 50 it looks lonely, but x = 100 looks like it made friends,” and then realizing I should stop eyeballing everything and use variables like centerX = width/2 and centerY = height/2.
...
### First Image
![Example Image](./Images/Week1Image.png)

## Influences & References
This first week didn’t start with deep art-history, but it did start a pattern: I’m drawn to simple forms that can read like characters or symbols. A circle isn’t just a circle for long before it becomes a face, an eye. The earliest influence was just the “language” of minimal marks: if I place two dots and a curve inside a circle, the viewer’s brain supplies the rest. That little trick is basically the gateway drug to generative symbolism huehuehue. Behold the face.
...
What failed: my entire unsaved progress and my dignity. But that failure forced me to treat process as reproducible, not magical.  


Next step: control and interaction. If I can make a drawing respond to me, maybe I can eventually make it feel like it transitions.
