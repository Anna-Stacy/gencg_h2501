...
Also: I had lost the Week 1 art because I had no account, so this week I made an account and re-vamped the work so I could stop living dangerously. This was the week I realized p5.js isn’t hard, but my file management habits are. Now it’s saved. Forever. Muhahaha.
...
I had the first ingredient: input driving change.  
...
## Critical Reflection
What worked: immediate satisfaction. Interactivity makes even a plain circle feel alive, like it has a pulse.

What failed: my early tendency to overdo the effect and accidentally create chaos. I learned that “responsive” doesn’t mean “over the top.” Basics are needed to learn for a reason.

Next step: make motion feel smoother. I want changes to feel like they have momentum, like a cycle, rather than snapping around like a nervous squirrel.