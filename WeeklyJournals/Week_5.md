...
## Exploration
We continued from last week and decided that reflections should be held in Week 6. I wanted to make shimmering waves. That would be so pretty. I love the ocean. My inspiration would be the starry night by Vincent van Gogh. He made the night sky look like a body of water swirlling with stars.

this was my first attempt. I wanted to work with noise, and interactivity. 
{% raw %}
...
I also used a reference script of the starry night from a p5.js user.
