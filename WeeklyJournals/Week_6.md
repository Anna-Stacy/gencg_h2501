...
{% endraw %}
Do not laugh, I tried so hard.

### References

After skimming the internet for any kind of reference for a unicorn in javascript, I came accross multiple p5.js websites with cute unicorn designs, some were interactive some not. These were some of my reference links:
Very first inspiration after research: https://editor.p5js.org/codingtrain/sketches/j2YhLFhxU  
 [Cute Unicorn Game](https://editor.p5js.org/ps218478/sketches/0SbhkfBRU)  
 Unicorn draw: https://editor.p5js.org/ps218478/sketches/0SbhkfBRU  
You can see the motivation from the first link, the other two gave me ideas on how to write the script.
